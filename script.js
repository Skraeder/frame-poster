...
function getProductFromCard(card) { return { name: card.dataset.name, category: card.dataset.category || "Poster", price: Number(card.dataset.price), image: card.dataset.image, frame: selectedFrame.name, frameClass: selectedFrame.className }; }
